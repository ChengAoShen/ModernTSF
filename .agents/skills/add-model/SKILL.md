...
construction/forward/backward checks, truthful provenance, and a component
decision for every defining operation. Declare every reused component in
`spec.py` and list it in the generated model-card section. Use
