...
| `configs/datasets/cauair_ccaq_st.toml` | `cauair_st` | CauAir/CCAQ air quality, node layout (spatiotemporal / air_quality) |
...
- `air_quality` — like spatiotemporal but the model also receives the future covariate block `(B, pred_len, N, F)`.
