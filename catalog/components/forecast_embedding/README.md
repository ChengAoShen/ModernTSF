...
kind: "component"
module: "components.forecast_embedding"
...
Implementation: [`src/components/forecast_embedding.py`](../../../src/components/forecast_embedding.py)
...
```python
from components.forecast_embedding import RawCalendarEmbedding, ForecastEmbedding
```
