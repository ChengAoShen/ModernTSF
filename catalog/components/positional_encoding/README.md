...
kind: "component"
module: "components.positional_encoding"
...
Implementation: [`src/components/positional_encoding.py`](../../../src/components/positional_encoding.py)
...
```python
import components.positional_encoding
```
