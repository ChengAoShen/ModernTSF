...
name: "quantile_head"
kind: "component"
module: "components.quantile_head"
...
Implementation: [`src/components/quantile_head.py`](../../../src/components/quantile_head.py)
...
```python
from components.quantile_head import QuantileHead, validate_quantile_levels, DEFAULT_QUANTILE_LEVELS
```
...
- [`mqrnn`](../../../src/models/mqrnn/README.md)
- [`quantile_dlinear`](../../../src/models/quantile_dlinear/README.md)
- [`quantile_patchtst`](../../../src/models/quantile_patchtst/README.md)
- [`tirex`](../../../src/models/tirex/README.md)
