...
- Expected root: `./dataset/BeijingAirQuality`
- Data selector/path: `BeijingAirQuality.csv`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/beijing_air.toml` and
