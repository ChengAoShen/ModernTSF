...
alias: "etth2"
mode: "time-series"
summary: "Time-series forecasting preset loaded by `ETTh2`."
---
...
Time-series forecasting preset loaded by `ETTh2`. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/etth2.toml` and
