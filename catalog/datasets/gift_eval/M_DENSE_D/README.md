...
mode: "gift-eval"
summary: "GIFT-Eval preset for 'M_DENSE/D' with forecast horizon 30."
---
...
GIFT-Eval preset for 'M_DENSE/D' with forecast horizon 30. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/M_DENSE_D.toml` and
