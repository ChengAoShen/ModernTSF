...
kind: "dataset"
config: "configs/datasets/gift_eval/M_DENSE_H.toml"
loader: "gift_eval"
alias: "gift_eval/M_DENSE_H"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'M_DENSE/H' with forecast horizon 48."
---
...
- Config: [`configs/datasets/gift_eval/M_DENSE_H.toml`](../../../../configs/datasets/gift_eval/M_DENSE_H.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `M_DENSE/H`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/M_DENSE_H.toml` and
