---
name: "gift_eval/SZ_TAXI_15T"
kind: "dataset"
config: "configs/datasets/gift_eval/SZ_TAXI_15T.toml"
loader: "gift_eval"
alias: "gift_eval/SZ_TAXI_15T"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'SZ_TAXI/15T' with forecast horizon 48."
---

# gift_eval/SZ_TAXI_15T

## Overview

GIFT-Eval preset for 'SZ_TAXI/15T' with forecast horizon 48. This card describes the repository preset and runtime contract; it
does not add an external-source provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/SZ_TAXI_15T.toml`](../../../../configs/datasets/gift_eval/SZ_TAXI_15T.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `SZ_TAXI/15T`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/SZ_TAXI_15T.toml` and
