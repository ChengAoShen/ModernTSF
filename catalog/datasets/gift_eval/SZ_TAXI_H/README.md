---
name: "gift_eval/SZ_TAXI_H"
kind: "dataset"
config: "configs/datasets/gift_eval/SZ_TAXI_H.toml"
loader: "gift_eval"
alias: "gift_eval/SZ_TAXI_H"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'SZ_TAXI/H' with forecast horizon 48."
---
...
GIFT-Eval preset for 'SZ_TAXI/H' with forecast horizon 48. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/SZ_TAXI_H.toml`](../../../../configs/datasets/gift_eval/SZ_TAXI_H.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `SZ_TAXI/H`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/SZ_TAXI_H.toml` and
