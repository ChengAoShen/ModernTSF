...
summary: "GIFT-Eval preset for 'bitbrains_fast_storage/5T' with forecast horizon 48."
---
...
GIFT-Eval preset for 'bitbrains_fast_storage/5T' with forecast horizon 48. This card describes the repository preset and runtime contract; it
...
- Data selector/path: `bitbrains_fast_storage/5T`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/bitbrains_fast_storage_5T.toml` and
