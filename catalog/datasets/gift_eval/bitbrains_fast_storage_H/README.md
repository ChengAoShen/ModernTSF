...
mode: "gift-eval"
summary: "GIFT-Eval preset for 'bitbrains_fast_storage/H' with forecast horizon 48."
---
...
GIFT-Eval preset for 'bitbrains_fast_storage/H' with forecast horizon 48. This card describes the repository preset and runtime contract; it
...
- Data selector/path: `bitbrains_fast_storage/H`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/bitbrains_fast_storage_H.toml` and
