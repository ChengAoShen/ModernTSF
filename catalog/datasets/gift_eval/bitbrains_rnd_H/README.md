---
name: "gift_eval/bitbrains_rnd_H"
kind: "dataset"
config: "configs/datasets/gift_eval/bitbrains_rnd_H.toml"
loader: "gift_eval"
alias: "gift_eval/bitbrains_rnd_H"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'bitbrains_rnd/H' with forecast horizon 48."
---

# gift_eval/bitbrains_rnd_H

## Overview

GIFT-Eval preset for 'bitbrains_rnd/H' with forecast horizon 48. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/bitbrains_rnd_H.toml`](../../../../configs/datasets/gift_eval/bitbrains_rnd_H.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `bitbrains_rnd/H`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/bitbrains_rnd_H.toml` and
