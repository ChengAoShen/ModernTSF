...
summary: "GIFT-Eval preset for 'bizitobs_l2c/H' with forecast horizon 48."
---
...
GIFT-Eval preset for 'bizitobs_l2c/H' with forecast horizon 48. This card describes the repository preset and runtime contract; it
...
- Data selector/path: `bizitobs_l2c/H`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/bizitobs_l2c_H.toml` and
