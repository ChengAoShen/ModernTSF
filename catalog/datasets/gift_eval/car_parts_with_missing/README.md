...
mode: "gift-eval"
summary: "GIFT-Eval preset for 'car_parts_with_missing' with forecast horizon 12."
---
...
- Data selector/path: `car_parts_with_missing`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/car_parts_with_missing.toml` and
