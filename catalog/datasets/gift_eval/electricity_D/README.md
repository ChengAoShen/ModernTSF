---
name: "gift_eval/electricity_D"
kind: "dataset"
config: "configs/datasets/gift_eval/electricity_D.toml"
loader: "gift_eval"
alias: "gift_eval/electricity_D"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'electricity/D' with forecast horizon 30."
---

# gift_eval/electricity_D

## Overview

GIFT-Eval preset for 'electricity/D' with forecast horizon 30. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/electricity_D.toml`](../../../../configs/datasets/gift_eval/electricity_D.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `electricity/D`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/electricity_D.toml` and
