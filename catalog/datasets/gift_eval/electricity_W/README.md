...
summary: "GIFT-Eval preset for 'electricity/W' with forecast horizon 8."
---
...
GIFT-Eval preset for 'electricity/W' with forecast horizon 8. This card describes the repository preset and runtime contract; it
...
- Data selector/path: `electricity/W`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/electricity_W.toml` and
