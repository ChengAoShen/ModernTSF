...
kind: "dataset"
config: "configs/datasets/gift_eval/ett1_15T.toml"
loader: "gift_eval"
alias: "gift_eval/ett1_15T"
task_modes: ["time_series"]
summary: "GIFT-Eval preset for 'ett1/15T' with forecast horizon 48."
---
...
GIFT-Eval preset for 'ett1/15T' with forecast horizon 48. This card describes the repository preset and runtime contract; it
does not add an external-source provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/ett1_15T.toml`](../../../../configs/datasets/gift_eval/ett1_15T.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `ett1/15T`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/ett1_15T.toml` and
