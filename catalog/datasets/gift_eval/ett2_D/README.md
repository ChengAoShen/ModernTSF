...
kind: "dataset"
config: "configs/datasets/gift_eval/ett2_D.toml"
loader: "gift_eval"
alias: "gift_eval/ett2_D"
task_modes: ["time_series"]
summary: "GIFT-Eval preset for 'ett2/D' with forecast horizon 30."
---
...
GIFT-Eval preset for 'ett2/D' with forecast horizon 30. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/ett2_D.toml` and
