...
mode: "gift-eval"
summary: "GIFT-Eval preset for 'hierarchical_sales/D' with forecast horizon 30."
---
...
GIFT-Eval preset for 'hierarchical_sales/D' with forecast horizon 30. This card describes the repository preset and runtime contract; it
...
- Data selector/path: `hierarchical_sales/D`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/hierarchical_sales_D.toml` and
