...
summary: "GIFT-Eval preset for 'jena_weather' with forecast horizon 48."
---
...
GIFT-Eval preset for 'jena_weather' with forecast horizon 48. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/jena_weather.toml` and
