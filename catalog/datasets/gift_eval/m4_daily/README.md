...
kind: "dataset"
config: "configs/datasets/gift_eval/m4_daily.toml"
loader: "gift_eval"
alias: "gift_eval/m4_daily"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'm4_daily' with forecast horizon 14."
---
...
GIFT-Eval preset for 'm4_daily' with forecast horizon 14. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/m4_daily.toml`](../../../../configs/datasets/gift_eval/m4_daily.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `m4_daily`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/m4_daily.toml` and
