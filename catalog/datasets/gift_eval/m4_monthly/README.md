---
name: "gift_eval/m4_monthly"
kind: "dataset"
config: "configs/datasets/gift_eval/m4_monthly.toml"
loader: "gift_eval"
alias: "gift_eval/m4_monthly"
task_modes: ["time_series"]
summary: "GIFT-Eval preset for 'm4_monthly' with forecast horizon 18."
---

# gift_eval/m4_monthly

## Overview

GIFT-Eval preset for 'm4_monthly' with forecast horizon 18. This card describes the repository preset and runtime contract; it
does not add an external-source provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/m4_monthly.toml`](../../../../configs/datasets/gift_eval/m4_monthly.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `m4_monthly`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/m4_monthly.toml` and
