...
kind: "dataset"
config: "configs/datasets/gift_eval/restaurant.toml"
loader: "gift_eval"
alias: "gift_eval/restaurant"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'restaurant' with forecast horizon 30."
---
...
GIFT-Eval preset for 'restaurant' with forecast horizon 30. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/restaurant.toml`](../../../../configs/datasets/gift_eval/restaurant.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `restaurant`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/restaurant.toml` and
