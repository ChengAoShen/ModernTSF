---
name: "gift_eval/saugeenday_M"
kind: "dataset"
config: "configs/datasets/gift_eval/saugeenday_M.toml"
loader: "gift_eval"
alias: "gift_eval/saugeenday_M"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'saugeenday/M' with forecast horizon 12."
---

# gift_eval/saugeenday_M

## Overview

GIFT-Eval preset for 'saugeenday/M' with forecast horizon 12. This card describes the repository preset and runtime contract; it
does not add an external-source provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/saugeenday_M.toml`](../../../../configs/datasets/gift_eval/saugeenday_M.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `saugeenday/M`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/saugeenday_M.toml` and
