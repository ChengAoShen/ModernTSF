...
kind: "dataset"
config: "configs/datasets/gift_eval/solar_D.toml"
loader: "gift_eval"
alias: "gift_eval/solar_D"
task_modes: ["time_series"]
summary: "GIFT-Eval preset for 'solar/D' with forecast horizon 30."
---
...
GIFT-Eval preset for 'solar/D' with forecast horizon 30. This card describes the repository preset and runtime contract; it
does not add an external-source provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/solar_D.toml`](../../../../configs/datasets/gift_eval/solar_D.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `solar/D`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/solar_D.toml` and
