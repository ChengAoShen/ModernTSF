...
summary: "GIFT-Eval preset for 'solar/W' with forecast horizon 8."
---
...
GIFT-Eval preset for 'solar/W' with forecast horizon 8. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/solar_W.toml` and
