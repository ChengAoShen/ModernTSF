...
kind: "dataset"
config: "configs/datasets/gift_eval/temperature_rain_with_missing.toml"
loader: "gift_eval"
alias: "gift_eval/temperature_rain_with_missing"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'temperature_rain_with_missing' with forecast horizon 30."
---
...
GIFT-Eval preset for 'temperature_rain_with_missing' with forecast horizon 30. This card describes the repository preset and runtime contract; it
does not add an upstream provenance claim that is absent from the configuration.

## Loader and files

- Registry loader: `gift_eval`
- Config: [`configs/datasets/gift_eval/temperature_rain_with_missing.toml`](../../../../configs/datasets/gift_eval/temperature_rain_with_missing.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `temperature_rain_with_missing`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/temperature_rain_with_missing.toml` and
