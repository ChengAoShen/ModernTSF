...
kind: "dataset"
config: "configs/datasets/gift_eval/us_births_W.toml"
loader: "gift_eval"
alias: "gift_eval/us_births_W"
mode: "gift-eval"
summary: "GIFT-Eval preset for 'us_births/W' with forecast horizon 8."
---
...
- Config: [`configs/datasets/gift_eval/us_births_W.toml`](../../../../configs/datasets/gift_eval/us_births_W.toml)
- Expected root: `./dataset/gift_eval`
- Data selector/path: `us_births/W`
- Track: `standard`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/gift_eval/us_births_W.toml` and
