...
name: "pems08"
kind: "dataset"
config: "configs/datasets/pems08.toml"
loader: "cauair_st"
alias: "pems08"
mode: "spatiotemporal"
...
- Config: [`configs/datasets/pems08.toml`](../../../configs/datasets/pems08.toml)
- Expected root: `./dataset/pems08`
...
Inspect availability with `tsf dataset inspect --config configs/datasets/pems08.toml` and
