...
summary: "Time-series forecasting preset loaded by `traffic`."
---
...
Time-series forecasting preset loaded by `traffic`. This card describes the repository preset and runtime contract; it
...
Inspect availability with `tsf dataset inspect --config configs/datasets/traffic.toml` and
