...
COMPONENT_CATALOG = ComponentCatalog(
    (
        ComponentSpec("adj_norm", "models._components.adj_norm", "Dense adjacency normalization.", keywords=("adjacency", "graph", "laplacian", "normalization")),
        ComponentSpec(
            "channel_alignment",
            "models._components.channel_alignment",
        ...
        ComponentSpec(
            "channel_wise_linear",
            "models._components.channel_wise_linear",
        ...
        ComponentSpec(
            "diffusion_conv",
            "models._components.diffusion_conv",
        ...
        ComponentSpec("embed", "models._components.embed", "Value, position, calendar, patch, and inverted embeddings.", keywords=("calendar", "embedding", "patch", "position", "token")),
        ComponentSpec(
            "dominant_periods",
            "models._components.dominant_periods",
        ...
        ComponentSpec(
            ...
            "models._components.flatten_forecast_head",
        ...
        ComponentSpec(
            "forecast_embedding",
            "models._components.forecast_embedding",
        ...
        ComponentSpec(
            ...
            "models._components.gaussian_parameter_head",
        ...
        ComponentSpec("graph_utils", "models._components.graph_utils", "Graph supports, Laplacians, and Chebyshev bases.", keywords=("adjacency", "chebyshev", "graph", "laplacian", "support")),
        ComponentSpec(
            "graph_spectral",
            "models._components.graph_spectral",
        ...
        ComponentSpec("marks", "models._components.marks", "Canonical temporal-mark and spatiotemporal input adapters.", keywords=("calendar", "covariate", "spatiotemporal", "timestamp")),
        ComponentSpec(
            "mamba",
            "models._components.mamba",
        ...
        ComponentSpec("masking", "models._components.masking", "Attention mask construction.", keywords=("attention", "causal", "mask")),
        ComponentSpec(
            "patchtst",
            "models._components.patchtst",
            "Patch extraction, time-series Transformer encoding, and PatchTST backbone.",
            ("PatchTSTBackbone",),
            ("backbone", "channel-independent", "patch", "transformer"),
        ),
        ComponentSpec("positional_encoding", "models._components.positional_encoding", "Patch-transformer positional encodings.", keywords=("encoding", "patch", "position", "transformer")),
        ComponentSpec(
            "quantile_head",
            "models._components.quantile_head",
        ...
        ComponentSpec("revin", "models._components.revin", "Reversible instance normalization.", ("RevIN",), ("denormalization", "instance", "normalization", "reversible")),
        ComponentSpec("self_attention_family", "models._components.self_attention_family", "Shared full and probabilistic attention layers.", keywords=("attention", "full", "probabilistic")),
        ComponentSpec(
            "soft_tree",
            "models._components.soft_tree",
        ...
        ComponentSpec(
            ...
            "models._components.series_decomposition",
        ...
        ComponentSpec("transformer_encdec", "models._components.transformer_encdec", "Shared Transformer encoder and decoder blocks.", keywords=("attention", "decoder", "encoder", "transformer")),
        ComponentSpec("tst_transformer", "models._components.tst_transformer", "Time-series Transformer encoder blocks.", keywords=("attention", "encoder", "time-series", "transformer")),
    )
)
