...
# Download all datasets to default location (~/.cache/gift_eval):
  uv run tsf dataset gift-download

# Download to a custom location:
  uv run tsf dataset gift-download --output-dir /data/gift_eval

# Download specific datasets only:
  uv run tsf dataset gift-download --datasets electricity/15T ett1/H m4_monthly
