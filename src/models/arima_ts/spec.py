"""Model specification for ARIMATS."""
...
def build_model(cfg, params):
    """Construct ARIMATS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    name='ARIMATS',
    module='models.arima_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/ARIMATS.toml',
    model_card='src/models/arima_ts/README.md',
    smoke_config=None,
