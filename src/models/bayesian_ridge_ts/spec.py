"""Model specification for BayesianRidgeTS."""
...
def build_model(cfg, params):
    """Construct BayesianRidgeTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.bayesian_ridge_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/BayesianRidgeTS.toml',
    model_card='src/models/bayesian_ridge_ts/README.md',
    smoke_config=None,
