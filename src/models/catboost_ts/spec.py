"""Model specification for CatBoostTS."""
...
def build_model(cfg, params):
    """Construct CatBoostTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    source=SourceRef(),
    evidence="adaptation",
    config_path='configs/models/CatBoostTS.toml',
    model_card='src/models/catboost_ts/README.md',
    smoke_config=None,
