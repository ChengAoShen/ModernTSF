"""Model specification for ElasticNetTS."""
...
def build_model(cfg, params):
    """Construct ElasticNetTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    name='ElasticNetTS',
    module='models.elastic_net_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/ElasticNetTS.toml',
    model_card='src/models/elastic_net_ts/README.md',
    smoke_config=None,
