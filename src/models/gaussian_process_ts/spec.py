"""Model specification for GaussianProcessTS."""
...
def build_model(cfg, params):
    """Construct GaussianProcessTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.gaussian_process_ts',
    model_class=Model,
    factory=build_model,
    ...
    source=SourceRef(),
    evidence="adaptation",
    config_path='configs/models/GaussianProcessTS.toml',
    model_card='src/models/gaussian_process_ts/README.md',
    smoke_config=None,
