"""Independent GRU forecasting baseline."""
...
class Model(nn.Module):
    """Encode a history with a GRU and decode its final state directly."""
    ...
    def __init__(self, seq_len: int, pred_len: int, enc_in: int, d_model: int = 64,
        ...
        self.encoder = nn.GRU(enc_in, d_model, num_layers=num_layers, batch_first=True,
