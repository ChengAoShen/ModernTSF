...
def build_model(cfg, params):
    """Construct HN_MVTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    source=SourceRef(),
    evidence="adaptation",
    config_path='configs/models/HN_MVTS.toml',
    model_card='src/models/hn_mvts/README.md',
    smoke_config=None,
