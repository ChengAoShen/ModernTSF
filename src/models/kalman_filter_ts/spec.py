"""Model specification for KalmanFilterTS."""
...
def build_model(cfg, params):
    """Construct KalmanFilterTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    name='KalmanFilterTS',
    module='models.kalman_filter_ts',
    model_class=Model,
    factory=build_model,
    ...
    source=SourceRef(),
    evidence="adaptation",
    config_path='configs/models/KalmanFilterTS.toml',
    model_card='src/models/kalman_filter_ts/README.md',
    smoke_config=None,
