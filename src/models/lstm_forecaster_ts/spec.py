"""Model specification for LSTMForecasterTS."""
...
def build_model(cfg, params):
    """Construct LSTMForecasterTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.lstm_forecaster_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/LSTMForecasterTS.toml',
    model_card='src/models/lstm_forecaster_ts/README.md',
    smoke_config=None,
