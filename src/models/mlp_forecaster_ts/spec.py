"""Model specification for MLPForecasterTS."""
...
def build_model(cfg, params):
    """Construct MLPForecasterTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.mlp_forecaster_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/MLPForecasterTS.toml',
    model_card='src/models/mlp_forecaster_ts/README.md',
    smoke_config=None,
