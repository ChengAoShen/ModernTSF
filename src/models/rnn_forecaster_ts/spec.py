"""Model specification for RNNForecasterTS."""
...
def build_model(cfg, params):
    """Construct RNNForecasterTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.rnn_forecaster_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/RNNForecasterTS.toml',
    model_card='src/models/rnn_forecaster_ts/README.md',
    smoke_config=None,
