...
SPEC = ModelSpec(name="SVRForecasterTS", module="models.svr_forecaster_ts", model_class=Model, factory=build_model, params_schema=ModelParameterConfig, config_path="configs/models/SVRForecasterTS.toml", model_card="src/models/svr_forecaster_ts/README.md", capabilities=frozenset(["time-series"]), components=(), contract_task={"seq_len": 96, "pred_len": 96, "label_len": 0})
