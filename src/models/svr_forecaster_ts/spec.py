"""Model specification for SVRForecasterTS."""
...
def build_model(cfg, params):
    """Construct SVRForecasterTS from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    ...
    module='models.svr_forecaster_ts',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/SVRForecasterTS.toml',
    model_card='src/models/svr_forecaster_ts/README.md',
    smoke_config=None,
