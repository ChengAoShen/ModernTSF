...
class Normalize(nn.Module):
    """RevIN-style instance normalization (upstream ``StandardNorm.Normalize``)."""
...
class _TimeAlignCore(nn.Module):
    ...
    def __init__(
        ...
        self.normalization_x = Normalize(enc_in, affine=False)
        self.normalization_y = Normalize(enc_in, affine=False)
