...
def build_model(cfg, params):
    """Construct TimeMosaic from a validated run configuration."""
    return (
...
SPEC = ModelSpec(
    name='TimeMosaic',
    module='models.timemosaic',
    model_class=Model,
    factory=build_model,
    params_schema=ModelParameterConfig,
    config_path='configs/models/TimeMosaic.toml',
    model_card='src/models/timemosaic/README.md',
    smoke_config=None,
