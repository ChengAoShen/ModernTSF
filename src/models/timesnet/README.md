...
generated by `scripts/verify_transformer_patch_rewrites.py`. FFT top-frequency
...
`[B, pred_len, c_out]`. Non-forecast tasks, official recipes, checkpoint parity,
and published-metric parity are omitted.
