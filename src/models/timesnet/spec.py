...
SPEC = ModelSpec(
    ...
    components=('conv_blocks', 'embed'),
    deviations=('FFT period discovery, period-aligned 2D reshaping, inception convolution, and amplitude-weighted aggregation are retained.', 'The licensed Time-Series-Library implementation is reduced to long-horizon forecasting and shared component imports.', 'Classification, imputation, anomaly detection, official data recipes, and training settings are outside this adapter.'),
