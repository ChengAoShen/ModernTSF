"""Contracts for exact-source GWNet, STNorm, and STDN parity evidence."""
...
MODELS = ("GWNet", "STNorm", "STDN")


class RemainingBasicTSParityTests(unittest.TestCase):
    def test_detailed_evidence_covers_strict_contract(self) -> None:
        for name in MODELS:
            with self.subTest(model=name):
                ...
                self.assertEqual(record["source"]["license"], "Apache-2.0")
